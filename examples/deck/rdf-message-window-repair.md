...
This deck follows a small RDF Message window where one door is reported both open and closed. The [rules](../rdf-message-window-repair.n3) inspect the replayed [message log input](../input/rdf-message-window-repair.trig), the [golden output](../output/rdf-message-window-repair.md) shows the repaired conclusion, and [The Art of Eyeron](../../the-art-of-eyeron.md#17-rdf-messages) explains how `-r` exposes message payloads without silently merging them.

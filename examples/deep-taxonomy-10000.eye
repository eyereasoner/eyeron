...
direct_subclass(n(?level), n(?next)) if ?level >= 0, ?level < 10000, let ?next = ?level + 1.
direct_subclass(n(?level), i(?next)) if ?level >= 0, ?level < 10000, let ?next = ?level + 1.
direct_subclass(n(?level), j(?next)) if ?level >= 0, ?level < 10000, let ?next = ?level + 1.
direct_subclass(n(10000), a2).
...
subsumed(n(?lower), n(?upper)) if ?lower >= 0, ?lower < ?upper, ?upper <= 10000.
subsumed(n(?lower), i(?branch)) if ?lower >= 0, ?lower < ?branch, ?branch <= 10000.
subsumed(n(?lower), j(?branch)) if ?lower >= 0, ?lower < ?branch, ?branch <= 10000.
subsumed(n(?lower), a2) if ?lower >= 0, ?lower <= 10000.
...
ask direct_subclass(n(4999), n(5000)).
ask direct_subclass(n(4999), i(5000)).
ask direct_subclass(n(4999), j(5000)).
ask subsumed(n(0), n(10000)).
ask classified_as(ind, i(5000)).
ask classified_as(ind, j(10000)).
ask classified_as(ind, a2).
ask not subsumed(i(5000), n(10000)).
ask not subsumed(i(5000), j(5000)).
ask not classified_as(ind, i(10001)).
ask not direct_subclass(n(-1), n(0)).
ask not subsumed(a2, n(10000)).

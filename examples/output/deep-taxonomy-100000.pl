...
answer(1, ['Check' = check3, 'Message' = "C3 OK - the chain reaches the midpoint n50000 and still carries both side-label branches."]).
answer(1, ['Check' = check4, 'Message' = "C4 OK - the final taxonomy step from n99999 to n100000 was completed."]).
answer(1, ['Check' = check5, 'Message' = "C5 OK - once n100000 is reached, the terminal class a2 is derived."]).

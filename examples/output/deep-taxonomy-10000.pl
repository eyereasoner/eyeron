...
answer(1,
       ['Check' = check3,
        'Message' = "C3 OK - the chain reaches the midpoint n5000 and still carries both side-label branches."]).
answer(1,
       ['Check' = check4,
        'Message' = "C4 OK - the final taxonomy step from n9999 to n10000 was completed."]).
answer(1,
       ['Check' = check5,
        'Message' = "C5 OK - once n10000 is reached, the terminal class a2 is derived."]).
answer(1,
       ['Check' = check6,

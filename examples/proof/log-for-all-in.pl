...
clause(2, sub_task(c, s1), true).
clause(3, sub_task(c, s2), true).
clause(4, sub_task(c, s3), true).
clause(5, state(s1, completed), true).
clause(6, state(s2, completed), true).
clause(7, state(s3, completed), true).

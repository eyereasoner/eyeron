...
clause(20, inherits_requirement(var('Later'), var('Req')), (derives_from(var('Later'), var('Earlier')), satisfies(var('Earlier'), var('Req')))).
clause(21, considers(var('Ctrl'), var('Strategy')), (design_goal(var('Ctrl'), var('Goal')), suggests(var('Goal'), var('Strategy')))).
clause(22, targets(var('Ctrl'), var('Req')), (design_goal(var('Ctrl'), var('Goal')), introduces_requirement(var('Goal'), var('Req')))).
clause(23, preserves(var('Ctrl'), var('Req')), (inherits_requirement(var('Ctrl'), var('Req')), considers(var('Ctrl'), var('Strategy')), compatible_with(var('Strategy'), var('Req')))).
clause(24, integrates(var('Ctrl'), var('Strategy')), (inherits_requirement(var('Ctrl'), var('Req')), considers(var('Ctrl'), var('Strategy')), compatible_with(var('Strategy'), var('Req')))).
clause(25, satisfies(var('Ctrl'), var('Req')), (targets(var('Ctrl'), var('Req')), considers(var('Ctrl'), var('Strategy')), enables(var('Strategy'), var('Req')))).
clause(26, integrates(var('Ctrl'), var('Strategy')), (targets(var('Ctrl'), var('Req')), considers(var('Ctrl'), var('Strategy')), enables(var('Strategy'), var('Req')))).
...
clause(30, available_for_future_tuning(var('Ctrl'), yes), realizes(var('Ctrl'), var('Strategy'))).
...
substitution(16, ['Ctrl' = c2, 'Strategy' = leadCompensator, 'Goal' = reduceOvershoot]).
...
substitution(20, ['Ctrl' = c2, 'Req' = stabilityReq, 'Strategy' = leadCompensator]).
...
substitution(21, ['Ctrl' = c2, 'Req' = trackingReq, 'Strategy' = leadCompensator]).
...
substitution(22, ['Ctrl' = c2, 'Req' = overshootReq, 'Strategy' = leadCompensator]).
...
substitution(35, ['Ctrl' = c2, 'Strategy' = leadCompensator, 'Goal' = reduceOvershoot]).
...
substitution(36, ['Ctrl' = c3, 'Strategy' = integralAction, 'Goal' = rejectDisturbance]).
...
substitution(43, ['Ctrl' = c2, 'Req' = overshootReq, 'Goal' = reduceOvershoot]).
...
substitution(44, ['Ctrl' = c3, 'Req' = disturbanceRejectionReq, 'Goal' = rejectDisturbance]).
...
substitution(45, ['C' = c2, 'R' = overshootReq]).
proof(45, solution([c2, overshootReq]), query, [uses(43, targets(c2, overshootReq))]).
substitution(46, ['C' = c3, 'R' = disturbanceRejectionReq]).
...
substitution(60, ['Ctrl' = c2, 'Req' = overshootReq, 'Goal' = reduceOvershoot]).
...
substitution(64, ['Ctrl' = c2, 'Req' = stabilityReq, 'Strategy' = leadCompensator]).
...
substitution(65, ['Ctrl' = c2, 'Req' = trackingReq, 'Strategy' = leadCompensator]).
...
substitution(66, ['Ctrl' = c2, 'Req' = stabilityReq, 'Strategy' = leadCompensator]).
...
substitution(67, ['Ctrl' = c2, 'Req' = trackingReq, 'Strategy' = leadCompensator]).
...
substitution(68, ['Ctrl' = c2, 'Req' = overshootReq, 'Strategy' = leadCompensator]).
...
substitution(78, ['Ctrl' = c3, 'Strategy' = integralAction, 'Goal' = rejectDisturbance]).
...
substitution(82, ['Ctrl' = c3, 'Req' = overshootReq, 'Strategy' = integralAction]).
...
substitution(83, ['Ctrl' = c3, 'Req' = stabilityReq, 'Strategy' = integralAction]).
...
substitution(84, ['Ctrl' = c3, 'Req' = trackingReq, 'Strategy' = integralAction]).
...
substitution(99, ['Ctrl' = c3, 'Req' = disturbanceRejectionReq, 'Goal' = rejectDisturbance]).
...
substitution(101, ['Ctrl' = c2, 'Req' = overshootReq, 'Goal' = reduceOvershoot]).
...
substitution(112, ['Ctrl' = c3, 'Strategy' = integralAction, 'Goal' = rejectDisturbance]).
...
substitution(113, ['Ctrl' = c2, 'Req' = stabilityReq, 'Strategy' = leadCompensator]).
...
substitution(114, ['Ctrl' = c2, 'Req' = trackingReq, 'Strategy' = leadCompensator]).
...
substitution(115, ['Ctrl' = c2, 'Strategy' = leadCompensator, 'Req' = stabilityReq]).
...
substitution(116, ['Ctrl' = c2, 'Req' = overshootReq, 'Strategy' = leadCompensator]).
...
substitution(128, ['C' = c3, 'S' = integralAction]).
...
substitution(139, ['Ctrl' = c2, 'Req' = overshootReq, 'Goal' = reduceOvershoot]).
...
substitution(140, ['Ctrl' = c3, 'Req' = disturbanceRejectionReq, 'Goal' = rejectDisturbance]).
...
substitution(147, ['Ctrl' = c2, 'Req' = overshootReq, 'Goal' = reduceOvershoot]).
...
substitution(153, ['Ctrl' = c2, 'Strategy' = leadCompensator, 'Goal' = reduceOvershoot]).
...
substitution(154, ['Ctrl' = c3, 'Strategy' = integralAction, 'Goal' = rejectDisturbance]).
...
substitution(159, ['Ctrl' = c2, 'Req' = stabilityReq, 'Strategy' = leadCompensator]).
...
substitution(160, ['Ctrl' = c2, 'Req' = trackingReq, 'Strategy' = leadCompensator]).
...
substitution(161, ['Ctrl' = c2, 'Req' = stabilityReq, 'Strategy' = leadCompensator]).
...
substitution(162, ['Ctrl' = c2, 'Req' = trackingReq, 'Strategy' = leadCompensator]).
...
substitution(163, ['Ctrl' = c2, 'Req' = overshootReq, 'Strategy' = leadCompensator]).
...
substitution(164, ['Ctrl' = c3, 'Req' = disturbanceRejectionReq, 'Strategy' = integralAction]).
...
substitution(180, ['Ctrl' = c3, 'Req' = overshootReq, 'Strategy' = integralAction]).
...
substitution(181, ['Ctrl' = c3, 'Req' = stabilityReq, 'Strategy' = integralAction]).
...
substitution(182, ['Ctrl' = c3, 'Req' = trackingReq, 'Strategy' = integralAction]).
...
substitution(202, ['Ctrl' = c3, 'Req' = disturbanceRejectionReq, 'Goal' = rejectDisturbance]).
...
substitution(204, ['Ctrl' = c2, 'Req' = overshootReq, 'Goal' = reduceOvershoot]).
...
substitution(215, ['Ctrl' = c3, 'Strategy' = integralAction, 'Goal' = rejectDisturbance]).
...
substitution(216, ['Ctrl' = c2, 'Req' = stabilityReq, 'Strategy' = leadCompensator]).
...
substitution(217, ['Ctrl' = c2, 'Req' = trackingReq, 'Strategy' = leadCompensator]).
...
substitution(218, ['Ctrl' = c2, 'Strategy' = leadCompensator, 'Req' = stabilityReq]).
...
substitution(219, ['Ctrl' = c2, 'Req' = overshootReq, 'Strategy' = leadCompensator]).
...
substitution(232, ['Ctrl' = c3, 'Strategy' = integralAction]).
proof(232, realizes(c3, integralAction), rule(28), [uses(228, integrates(c3, integralAction))]).
substitution(233, ['C' = c3, 'S' = integralAction]).
...
substitution(237, ['C' = c1, 'S' = approvedController]).
...
substitution(249, ['Ctrl' = c3, 'Req' = disturbanceRejectionReq, 'Goal' = rejectDisturbance]).
...
substitution(251, ['Ctrl' = c2, 'Req' = overshootReq, 'Goal' = reduceOvershoot]).
...
substitution(262, ['Ctrl' = c3, 'Strategy' = integralAction, 'Goal' = rejectDisturbance]).
...
substitution(263, ['Ctrl' = c2, 'Req' = stabilityReq, 'Strategy' = leadCompensator]).
...
substitution(264, ['Ctrl' = c2, 'Req' = trackingReq, 'Strategy' = leadCompensator]).
...
substitution(265, ['Ctrl' = c2, 'Strategy' = leadCompensator, 'Req' = stabilityReq]).
...
substitution(266, ['Ctrl' = c2, 'Req' = overshootReq, 'Strategy' = leadCompensator]).
...
substitution(299, ['Ctrl' = c3, 'Req' = disturbanceRejectionReq, 'Goal' = rejectDisturbance]).
...
substitution(301, ['Ctrl' = c2, 'Req' = overshootReq, 'Goal' = reduceOvershoot]).
...
substitution(312, ['Ctrl' = c3, 'Strategy' = integralAction, 'Goal' = rejectDisturbance]).
...
substitution(313, ['Ctrl' = c2, 'Req' = stabilityReq, 'Strategy' = leadCompensator]).
...
substitution(314, ['Ctrl' = c2, 'Req' = trackingReq, 'Strategy' = leadCompensator]).
...
substitution(315, ['Ctrl' = c2, 'Strategy' = leadCompensator, 'Req' = stabilityReq]).
...
substitution(316, ['Ctrl' = c2, 'Req' = overshootReq, 'Strategy' = leadCompensator]).
